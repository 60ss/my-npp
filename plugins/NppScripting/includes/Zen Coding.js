...
var zen_settings = {
	...
	'html': {
		...
		'abbreviations': {
			...
			'form:g': '<form action="" method="get">',
			'form:p': '<form action="" method="post">',
			'form:file': '<form action="" method="post" enctype="multipart/form-data">',
			'form:f': '<form action="" method="post" enctype="multipart/form-data">',
			'label': '<label for="">',
			'input': '<input type="" />',
			...
			'input:submit': '<input type="submit" name="" value="" />',
			'input:s': '<input type="submit" name="" value="" />',
			...
			'textarea': '<textarea name="" cols="30" rows="10">',
